...
== WIP v0.24.0: New Features

As the releases before, this release has 100% test coverage.
Tested with Go 1.14, 1.15 and Go 1.16.
...
The build system is a separate import package: `import "github.com/zhizh/go-getoptions/dag"`
...
An example showing subcommands can be found in https://github.com/zhizh/go-getoptions/tree/master/examples/mygit[./examples/mygit].
...
An example can be found in https://github.com/zhizh/go-getoptions/tree/master/examples/mygit[./examples/mygit].
