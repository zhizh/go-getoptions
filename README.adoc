= go-getoptions
David Gamba, https://github.com/zhizh
:idprefix:
:name: go-getoptions
:toc: macro
:toclevels: 4
...
image:https://pkg.go.dev/badge/github.com/zhizh/go-getoptions.svg["Go Reference", link="https://pkg.go.dev/github.com/zhizh/go-getoptions"]
image:https://travis-ci.org/zhizh/go-getoptions.svg?branch=master["Build Status", link="https://travis-ci.org/zhizh/go-getoptions"]
image:https://codecov.io/github/zhizh/go-getoptions/coverage.svg?branch=master["Coverage via Codecov", link="https://codecov.io/github/zhizh/go-getoptions?branch=release"]
...
. Get it from github:
+
`go get github.com/zhizh/go-getoptions`

. Then import it:
+
`import "github.com/zhizh/go-getoptions" // As getoptions`
...
NOTE: For a <<quick_overview>>, jump to that section in the TOC or review the http://godoc.org/github.com/zhizh/go-getoptions[GoDoc Documentation].
